...
public abstract class TeachEvalRequest<T> : BaseRequest<T>, ISystemParams
{
...
public abstract class TeachEvalPagedRequest<T> : TeachEvalRequest<PagedResponseModel<T>>, ISystemParams
{
